...
const PricingSection: React.FC = () => {
  return (
    <section className="max-w-4xl mx-auto p-6 bg-gray-800 rounded-lg shadow-xl mt-14">
      <h2 className="text-3xl font-bold mb-6 text-center text-primary">API Pricing</h2>
          ...
          <tbody>
            {pricingTiers.map((tier, index) => (
              <tr key={index} className="border-b border-gray-700 hover:bg-gray-700 transition-colors">
                ...
                <td className="p-3">{tier.model}</td>
